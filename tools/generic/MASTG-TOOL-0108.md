...
- **No App Store**: The devices don't have the App Store, which means you can't use a Corellium device to obtain a decrypted version of an IPA file.
- **No Apple Services**: Access to Apple services (including iMessage and push notifications) is unavailable.
- **No Camera / Cellular / NFC / Bluetooth**: Apps running on Corellium don't have access to these peripherals. But it does support [simulated SMS sending](https://support.corellium.com/features/messaging).
