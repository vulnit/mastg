...
Start Ghidra using `ghidraRun` (\*nix) or `ghidraRun.bat` (Windows), depending on the platform you're on. Once Ghidra is fired up, create a new project by specifying the project directory. You'll be greeted by a window as shown below:
