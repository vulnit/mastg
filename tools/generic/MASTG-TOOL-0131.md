...
- **Transformed format**: The libraries are no longer in their original format, but rather, they are part of the app's compiled binary code. For instance, an Android app doesn't contain third-party JAR files in the APK because they are part of the compiled DEX files.
