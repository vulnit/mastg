...
drozer runs both in Android emulators and on real devices. It doesn't require USB debugging or other development features to be enabled, so you can perform assessments on devices in their production state to simulate attacks.
