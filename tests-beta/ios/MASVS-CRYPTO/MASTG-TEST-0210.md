...
- **CryptoKit**: This library doesn't support weak encryption algorithms. It only supports secure **symmetric algorithms** including AES-GCM and ChaChaPoly.
