...
The content-world-aware variant [`evaluateJavaScript(_:in:in:completionHandler:)`](https://developer.apple.com/documentation/webkit/wkwebview/evaluatejavascript(_:in:in:completionhandler:)) runs the script in an isolated world with an independent prototype chain that page JavaScript can't modify.
