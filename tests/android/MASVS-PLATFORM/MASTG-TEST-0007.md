...
Here we see that there are actually two paths, "/Keys" and "/Passwords", and the latter isn't being protected in the manifest and is therefore vulnerable.
